...
int get_buffer_cache_hit_rate() { return syscall0(SYS_CACHE_STATS); }

void reset_buffer_cache_stats() { return syscall0(SYS_RESET_CACHE_STATS); }

void buffer_cache_reset() { return syscall0(SYS_RESET_CACHE); }

int get_read_count() { return syscall0(SYS_READ_COUNT); }

int get_write_count() { return syscall0(SYS_WRITE_COUNT); }